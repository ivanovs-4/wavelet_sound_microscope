...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        edit_swap_red_and_blue_action = self.create_action("Sw&ap Red and Blue",
                self.edit_swap_red_and_blue, "Ctrl+A", "editswap",
        ...
        help_about_action = self.create_action("&About Image Changer", self.help_about)
        help_help_action = self.create_action("&Help", self.help_help, QKeySequence.HelpContents)
        ...
        self.zoom_spin_box.valueChanged.connect(self.show_image)
